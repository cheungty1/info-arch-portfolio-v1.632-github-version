...
export const getStaticProps = async () => {
  ...
  const response = await fetch(
    `https://newsapi.org/v2/everything?q=tech&pageSize=30&apiKey=${process.env.NEWS_API_KEY}`
  );
